...
The next comparative criterion is C4 long-term suitability. That step should evaluate whether each metric remains
informative over longer histories and whether it can be updated incrementally without recomputing the full project history.
