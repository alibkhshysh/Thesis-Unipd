...
Phase II starts with the most empirical comparison criterion: stability. The purpose of this step is to
...
M1 exhibits the lowest observed volatility because project size changes slowly between adjacent stable releases.
...
Table~\ref{tab:c1_window_stability_summary} and the figures in this section retain the original 70-window baseline.
Section~\ref{sec:posthoc_ancestry_validation} audits whether those tag-chronological windows are also linear Git
intervals and reports the separate ancestry-only C1 sensitivity result before the remaining decision criteria are interpreted.
