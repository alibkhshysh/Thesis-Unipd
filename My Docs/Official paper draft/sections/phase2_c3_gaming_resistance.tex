...
The third Phase II criterion evaluates how easily each metric can be manipulated. This criterion is necessary because
...
that likely manipulation is visible and can be controlled through cross-checks. The dimensions
\texttt{C3\_D1}--\texttt{C3\_D5} are local to the C3 gaming-resistance criterion; they are not the same as
the later feasibility dimensions D1--D10.

The C3 scores are structured author assessments of documented attack surfaces and safeguards. No adversarial experiment,
developer study, or manipulation simulation was performed. A high C3 score therefore means ``judged comparatively stronger
under this rubric,'' not empirically proven resistance to gaming.
...
\midrule
M4 & Ownership / concentration & Implemented & 9/10 & High & Strongest profile under the C3 rubric, but still needs identity and dominance caveats. \\
...
\begin{itemize}[leftmargin=*]
  ...
  \item M4 is the strongest candidate under the current C3 rubric, provided identity handling and dominance spikes are documented.
  \item M5 remains excluded from the current comparison decision because the evidence needed to audit responsiveness is absent.
\end{itemize}
